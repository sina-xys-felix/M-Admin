import { ResponsiveValue, FormItem, FieldRule, ColProps } from '@arco-design/web-vue'
...
interface MFormItemProps {
  ...
  props?: { [key: string]: unknown } // 表单项参数或者属性，根据arco-design官方文档来确定，该属性会透传到组件
  render?: (scope: Node) => VNode // 自定义搜索内容渲染（tsx语法）
}
