    ...
    <a-space :direction="direction" :size="mode === 'text' ? 'small' : 'mini'">
      ...
      <template v-if="isPermission">
        <a-tooltip :content="t('common.table.look')">
          <a-button v-if="showDetail" v-permission="detailCode" :type="mode !== 'icon' ? 'primary' : 'text'"
            status="normal" @click="handleClickOps(Operations.LOOK, record)">
            <div class="flex-btn">
        ...
        <a-tooltip :content="t('common.table.edit')">
          <a-button v-if="showUpdate" v-permission="updateCode" :type="mode !== 'icon' ? 'primary' : 'text'"
            :status="mode !== 'icon' ? 'success' : 'normal'" @click="handleClickOps(Operations.EDIT, record)">
            <div class="flex-btn">
        ...
        <a-tooltip :content="t('common.delete')">
          <a-button v-if="showRemove" v-permission="removeCode" :type="mode !== 'icon' ? 'primary' : 'text'"
            :status="mode !== 'icon' ? 'danger' : 'normal'" @click="handleClickOps(Operations.DELETE, record)">
            <div class="flex-btn">
      ...
      <template v-else>
        <a-tooltip :content="t('common.table.look')">
          <a-button v-if="showDetail" :type="mode !== 'icon' ? 'primary' : 'text'" status="normal"
        ...
        <a-tooltip :content="t('common.table.edit')">
          <a-button v-if="showUpdate" :type="mode !== 'icon' ? 'primary' : 'text'"
            :status="mode !== 'icon' ? 'success' : 'normal'" @click="handleClickOps(Operations.EDIT, record)">
            <div class="flex-btn">
              <icon-edit v-if="mode !== 'text'" size="18" />
              <span v-if="mode !== 'icon'">{{ $t('common.table.edit') }}</span>
        ...
        <a-tooltip :content="t('common.delete')">
          <a-button v-if="showRemove" :type="mode !== 'icon' ? 'primary' : 'text'"
            :status="mode !== 'icon' ? 'danger' : 'normal'" @click="handleClickOps(Operations.DELETE, record)">
            <div class="flex-btn">
              <icon-delete v-if="mode !== 'text'" size="18" />
              <span v-if="mode !== 'icon'">{{ $t('common.delete') }}</span>
