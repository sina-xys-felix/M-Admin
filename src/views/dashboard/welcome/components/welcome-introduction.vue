  ...
  <Card :title="$t('dashboard.welcome.introduction')">
    <div class="introduction">
      ...
      <div class="introduction-content">
        ...
        <p>文档地址：<a href="https://m-admin.cn/docs" target="_blank">https://m-admin.cn/docs</a></p>
        <p>
          源码地址：<a href="https://github.com/sina-xys-felix/M-Admin" target="_blank">https://github.com/sina-xys-felix/M-Admin</a>
        </p>
      </div>
    </div>
  </Card>
