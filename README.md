...
https://github.com/sina-xys-felix/M-Admin
...
| 平台              | 预览地址                                                   |
| ----------------- | ---------------------------------------------------------- |
| **github**        | [M-Admin 预览地址](https://sina-xys-felix.github.io/M-Admin/) |
...
| 平台              | 预览地址                                                                              | 仓库地址                                                                        |
| ----------------- | ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------- |
| **gitee**（码云） | <a href="https://sina-xys-felix.github.io/M-Admin/" target="_blank">M-Admin 预览地址</a>   | <a href="https://gitee.com/sina_xys/m-admin" target="_blank">Gitee  仓库地址</a> |
| **github**        | <a href="https://sina-xys-felix.github.io/M-Admin/" target="_blank">M-Admin 预览地址</a> | <a href="https://github.com/sina-xys-felix/M-Admin" target="_blank">Github 仓库地址</a> |
